...
@section('pageTitle', 'Halaman Ubah Buku')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-content">
                    <form action="{{ url('/admin/buku/' . $buku['id_buku']) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <div class="row">
                                ...
                                <div class="form-group label-floating{{ $errors->has('id_kategori') ? ' has-error' : '' }}">
                                    ...
                                    <select name="id_kategori" id="id_kategori" class="form-control">
                                        ...
                                        @foreach($kategori as $row)
                                            <option value="{{ $row['id_kategori'] }}" {{ old('id_kategori', $buku['id_kategori']) == $row['id_kategori'] ? 'selected' : '' }}>
                                                {{ $row['nama'] }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group label-floating{{ $errors->has('judul') ? ' has-error' : '' }}">
                                    ...
                                    <input id="judul" type="text" class="form-control" name="judul" value="{{ old('judul', $buku['judul']) }}" required autofocus>
                                    <span class="material-input"></span>
                                    @if ($errors->has('judul'))
                                        <span class="help-block">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group label-floating{{ $errors->has('pengarang') ? ' has-error' : '' }}">
                                    ...
                                    <input id="pengarang" type="text" class="form-control" name="pengarang" value="{{ old('pengarang', $buku['pengarang']) }}" required autofocus>
                                    <span class="material-input"></span>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group label-floating{{ $errors->has('penerbit') ? ' has-error' : '' }}">
                                    ...
                                    <input id="penerbit" type="text" class="form-control" name="penerbit" value="{{ old('penerbit', $buku['penerbit']) }}" required autofocus>
                                    <span class="material-input"></span>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4">
                                ...
                                <div class="form-group label-floating{{ $errors->has('tahun_terbit') ? ' has-error' : '' }}">
                                    ...
                                    <input id="tahun_terbit" type="text" class="form-control" name="tahun_terbit" value="{{ old('tahun_terbit', $buku['tahun_terbit']) }}" required autofocus>
                                    <span class="material-input"></span>
                            ...
                            <div class="col-md-4 col-lg-4">
                                ...
                                <div class="form-group label-floating{{ $errors->has('jumlah_halaman') ? ' has-error' : '' }}">
                                    ...
                                    <input id="jumlah_halaman" type="text" class="form-control" name="jumlah_halaman" value="{{ old('jumlah_halaman', $buku['jumlah_halaman']) }}" required autofocus>
                                    <span class="material-input"></span>
